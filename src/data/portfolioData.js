export const projectsData = [
 ...
 
  {
    ...
    resume: "Il s'agit d'aider une grande entreprise technologique victime de piratages à identifier l'origine et le nombre de hackers. Heureusement, leurs ingénieurs légistes ont saisi des données précieuses sur les hacks, y compris des informations telles que l'heure de la session, les emplacements, la vitesse de frappe en wpm, etc. Ces données précieuses vont être explorées avec PySpark.",
    detail:"",
