export const projectsData = [
  ...
  
  {
    ...
    languagesIcons:["fab fa-python", "fab fa-jupyter", "fab fa-Anaconda", "fa-light fa-file-csv", "fab fa-github"],
  ...
  
  {
    ...
    languagesIcons:["fab fa-python", "fab fa-jupyter", "fas fa-Anaconda", "fa-solid fa-file-csv"],
    python_packages: ["Pandas", "Jupyter"],
