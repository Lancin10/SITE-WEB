export const projectsData = [
  ...
  
  {
    ...
    languagesIcons:["fab fa-python", "fab fa-jupyter", "fab fa-Anaconda", 'fas fa-file-csv'],
  ...
  
  {
    ...
    languagesIcons:["fab fa-python", "fab fa-jupyter", "fas fa-Anaconda", 'fas fa-file-csv'],
    python_packages: ["Pandas", "Jupyter"],
